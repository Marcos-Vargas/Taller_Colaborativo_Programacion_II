...
public class Features {
	...
	private final String DEFAULT_MESSAGE; // Unchangeable string
	private static int increaseAscii=7; // Cesar Encryption Code (Encrypt Method)
	...
	*/
	...
	public static String encrypt(String word) {
		...
		for (byte b : bytes) {
			...
			encryptStr+=(char)(b+(byte)word.length());
		}
	...
	*/
	...
	public static String decrypt(String word) {
		...
		for (int i = 0; i < bytes.length; i++) {
			...
			decrypttStr+=(char)(bytes[i]-word.length());
		}
		return decrypttStr;
	}
