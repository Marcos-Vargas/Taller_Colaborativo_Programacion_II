...
public class Application {
	...
	public static void main(String[] args) {
		...
		Features f;
		boolean remain=true;
	/*	Features m = new Features("Sogamoso ciudad del sol y del acero");
		System.out.println(m.ConvertProperName());
		System.out.println(m.searchTimeWord("S"));
		System.out.println(m.encrypt("ball"));
		System.out.println(m.decrypt("fepp"));
		System.out.println(m.addCharacters('B',58, "Izquierda"));
		System.out.println(m.deleteCharacter('o'));
		System.out.println(m.intersectStrings("Colombia"));
		System.out.println(m.differentiateStrings("Colombia"));
		System.out.println(m.deleteCharactersWithWord("Sogamoso ", "Derecha"));
		System.out.println(m.validateEmail(".RoscadelasC.asdasd.@gmail.ca.edu.za"));
	*/	
		f= new Features(JOptionPane.showInputDialog(null,"Ingrese la cadena por defecto para la aplicacion"));
		while(remain && f.getDEFAULT_MESSAGE()!=null) {
			...
			case "Desencriptar":
				...
				JOptionPane.showMessageDialog(null,"Cadena original: "+string+
						"\nCadena desencriptada: "+ f.encrypt(string));
			...
			case "Agregar caracteres":
				...
				String orientation =(String)JOptionPane.showInputDialog(null,"Elija donde añadir caracteres: ",
						"",1,null,new Object[] {"Iquierda","Derecha" },null);
				JOptionPane.showMessageDialog(null,"Cadena original: "+f.getDEFAULT_MESSAGE()+
